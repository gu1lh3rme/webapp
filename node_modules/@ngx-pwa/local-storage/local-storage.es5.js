...
var IndexedDBDatabase = (function (_super) {
    ...
    function (key, data) {
        ...
        map(function () { return transaction.get(key); }), mergeMap(function (request) {
            /* Listening to the success event, and passing the item value if found, null otherwise */
            var /** @type {?} */ success = (/** @type {?} */ (fromEvent(request, 'success'))).pipe(map(function (event) { return (/** @type {?} */ (event.target)).result; }));
            /* Merging success and errors events and autoclosing the observable */
...
export { LocalDatabase, IndexedDBDatabase, LocalStorageDatabase, MockLocalDatabase, JSONValidator, LocalStorage, LocalStorageModule, localStorageProviders, LOCAL_STORAGE_PREFIX, LocalStorage as AsyncLocalStorage, LocalDatabase as AsyncLocalDatabase, LocalStorageModule as AsyncLocalStorageModule, databaseFactory as ɵa };
//# sourceMappingURL=local-storage.es5.js.map
