 ...
 * @suppress {checkTypes} checked by tsc
 */
class IndexedDBDatabase extends LocalDatabase {
    /**
    ...
    setItem(key, data) {
        ...
        map(() => transaction.get(key)), mergeMap((request) => {
            /* Listening to the success event, and passing the item value if found, null otherwise */
            const /** @type {?} */ success = (/** @type {?} */ (fromEvent(request, 'success'))).pipe(map((event) => (/** @type {?} */ (event.target)).result));
            /* Merging success and errors events and autoclosing the observable */
 ...
 * @suppress {checkTypes} checked by tsc
 */
class LocalStorageDatabase extends LocalDatabase {
    /**
     * @param {?=} userPrefix
     */
 ...
 * @suppress {checkTypes} checked by tsc
 */
class MockLocalDatabase extends LocalDatabase {
    constructor() {
        super(...arguments);
