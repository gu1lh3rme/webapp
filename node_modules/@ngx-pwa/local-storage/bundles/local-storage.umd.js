(function (global, factory) {
	...
	(factory((global.ngxPWA = global.ngxPWA || {}, global.ngxPWA.localStorage = global.ngxPWA.localStorage || {}),global.ng.core,global.Rx,global.Rx.operators,global.Rx.Observable,global.Rx.Observable,global.Rx.Observable,global.Rx.Observable,global.ng.common));
...
var IndexedDBDatabase = (function (_super) {
    ...
    function IndexedDBDatabase(prefix) {
        ...
        if (prefix) {
            _this.dbName = prefix + "_" + _this.dbName;
        }
    ...
    function (key, data) {
        ...
        rxjs_operators.map(function () { return transaction.get(key); }), rxjs_operators.mergeMap(function (request) {
            /* Listening to the success event, and passing the item value if found, null otherwise */
            var /** @type {?} */ success = (/** @type {?} */ (rxjs_observable_fromEvent.fromEvent(request, 'success'))).pipe(rxjs_operators.map(function (event) { return (/** @type {?} */ (event.target)).result; }));
            /* Merging success and errors events and autoclosing the observable */
            return (rxjs_observable_race.race(success, _this.toErrorObservable(request, "setter")))
                .pipe(rxjs_operators.first());
    ...
    IndexedDBDatabase.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: _angular_core.Optional }, { type: _angular_core.Inject, args: [LOCAL_STORAGE_PREFIX,] },] },
    ]; };
...
var LocalStorageDatabase = (function (_super) {
    ...
    function LocalStorageDatabase(userPrefix) {
        ...
        var _this = _super.call(this) || this;
        _this.userPrefix = userPrefix;
        _this.prefix = '';
        if (userPrefix) {
            _this.prefix = userPrefix + "_";
        }
        return _this;
    }
    /**
 ...
 * @return {?}
 */
function databaseFactory(platformId, prefix) {
        ...
        { type: _angular_core.NgModule, args: [{
                    providers: [
                        JSONValidator,
                        {
                            ...
                            deps: [_angular_core.PLATFORM_ID, [new _angular_core.Optional(), LOCAL_STORAGE_PREFIX]]
                        },
                        LocalStorage,
                    ]
                },] },
...
exports.AsyncLocalStorage = LocalStorage;
exports.AsyncLocalDatabase = LocalDatabase;
exports.AsyncLocalStorageModule = LocalStorageModule;
